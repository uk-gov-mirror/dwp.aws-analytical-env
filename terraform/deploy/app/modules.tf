...
module launcher {
  ...
  hive_metastore_secret_id              = data.aws_secretsmanager_secret_version.hive_metastore_v2_password_secret.secret_id
  batch_security_configuration          = module.emr.batch_security_configuration
  hive_metastore_arn                    = data.aws_secretsmanager_secret_version.hive_metastore_v2_password_secret.arn
  subnet_ids                            = data.terraform_remote_state.aws_analytical_environment_infra.outputs.vpc.aws_subnets_private.*.id
