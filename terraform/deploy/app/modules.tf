...
module "emr" {
  ...
  internet_proxy          = data.terraform_remote_state.aws_analytical_environment_infra.outputs.vpc.internet_proxy_vpce.dns_name
  internet_proxy_sg_id    = data.terraform_remote_state.aws_analytical_environment_infra.outputs.vpc.internet_proxy_vpce.sg_id
